...
python test_models.py -m 0 train models -e 1000 -s 100 -os 900

# ## --------------------------------------------------------
# ## rm models/MLP__Extrapolation_vdist8_1.eqx
# rm Figures/training/*.png
# python test_models.py -m 1 train models -e 1000 -s 50 -os 100

## --------------------------------------------------------
# # rm models/MLP__Extrapolation_vdist8_2.eqx
# rm Figures/training/*.png
# python test_models.py -m 2 train models -e 1000 -s 50 -os 100

## --------------------------------------------------------
# # rm models/MLP__Extrapolation_vdist8_3.eqx
# rm Figures/training/*.png
# python test_models.py -m 3 train models -e 1000 -s 50 -os 100
